...
![Version: 0.19.60](https://img.shields.io/badge/Version-0.19.60-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.236.2](https://img.shields.io/badge/AppVersion-v2.236.2-informational?style=flat-square)
...
| https://helm.vector.dev | vector-agent(vector) | 0.49.0 |
| https://helm.vector.dev | vector-aggregator(vector) | 0.49.0 |
